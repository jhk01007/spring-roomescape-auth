...
- [x] **10. 로그인하지 않은 사용자는 예약을 생성할 수 없다.**
  - 요청 흐름
    - 인증 정보 없이 `POST /reservations`
  - 검증
    - `401 Unauthorized`가 반환된다.

- [x] **11. 일반 사용자는 관리자 예약 목록을 조회할 수 없다.**
  - 요청 흐름
    - 일반 사용자로 로그인
    - `GET /admin/reservations`
  - 검증
