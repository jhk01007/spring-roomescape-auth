...
import roomescape.auth.infra.FakePasswordEncoder;
...
class PasswordTest {
    ...
    void create_fail1() {
        assertDomainException(
                () -> Password.encode(null, fakePasswordEncoder),
                EMPTY_PASSWORD
        );
    }
    ...
    void create_fail2() {
        assertDomainException(
                () -> Password.encode("abc123", fakePasswordEncoder),
    ...
    void create_fail3() {
        assertDomainException(
                () -> Password.encode("12345678", fakePasswordEncoder),
    ...
    void create_fail4() {
        assertDomainException(
                () -> Password.encode("password", fakePasswordEncoder),
    ...
    void create_fail5() {
        assertDomainException(
                () -> Password.encode("password 1", fakePasswordEncoder),
