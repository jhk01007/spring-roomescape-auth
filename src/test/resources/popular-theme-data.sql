...
VALUES (1, 1, 1, '2026-04-29', 1, 1),
       (2, 1, 2, '2026-04-29', 2, 1),
       (3, 1, 3, '2026-04-30', 1, 1),
       (4, 1, 4, '2026-04-30', 2, 1),
       (5, 1, 5, '2026-05-01', 1, 1),
       (6, 1, 6, '2026-05-01', 2, 1),
       (7, 1, 7, '2026-05-02', 1, 1),
       (8, 1, 8, '2026-05-03', 1, 1),
       (9, 1, 9, '2026-05-04', 1, 1),
       (10, 1, 10, '2026-05-05', 1, 1);

-- Theme 2: 기간 내 예약 9개
INSERT INTO reservation (id, store_id, guest_id, date, time_id, theme_id)
VALUES (11, 1, 11, '2026-04-29', 1, 2),
       (12, 1, 12, '2026-04-29', 2, 2),
       (13, 1, 13, '2026-04-30', 1, 2),
       (14, 1, 14, '2026-04-30', 2, 2),
       (15, 1, 15, '2026-05-01', 1, 2),
       (16, 1, 16, '2026-05-01', 2, 2),
       (17, 1, 17, '2026-05-02', 1, 2),
       (18, 1, 18, '2026-05-03', 1, 2),
       (19, 1, 19, '2026-05-04', 1, 2);

-- Theme 3: 기간 내 예약 8개
INSERT INTO reservation (id, store_id, guest_id, date, time_id, theme_id)
VALUES (20, 1, 20, '2026-04-29', 1, 3),
       (21, 1, 21, '2026-04-29', 2, 3),
       (22, 1, 22, '2026-04-30', 1, 3),
       (23, 1, 23, '2026-04-30', 2, 3),
       (24, 1, 24, '2026-05-01', 1, 3),
       (25, 1, 25, '2026-05-01', 2, 3),
       (26, 1, 26, '2026-05-02', 1, 3),
       (27, 1, 27, '2026-05-03', 1, 3);

-- Theme 4: 기간 내 예약 7개
INSERT INTO reservation (id, store_id, guest_id, date, time_id, theme_id)
VALUES (28, 1, 28, '2026-04-29', 1, 4),
       (29, 1, 29, '2026-04-29', 2, 4),
       (30, 1, 30, '2026-04-30', 1, 4),
       (31, 1, 31, '2026-04-30', 2, 4),
       (32, 1, 32, '2026-05-01', 1, 4),
       (33, 1, 33, '2026-05-01', 2, 4),
       (34, 1, 34, '2026-05-02', 1, 4);

-- Theme 5: 기간 내 예약 6개
INSERT INTO reservation (id, store_id, guest_id, date, time_id, theme_id)
VALUES (35, 1, 35, '2026-04-29', 1, 5),
       (36, 1, 36, '2026-04-29', 2, 5),
       (37, 1, 37, '2026-04-30', 1, 5),
       (38, 1, 38, '2026-04-30', 2, 5),
       (39, 1, 39, '2026-05-01', 1, 5),
       (40, 1, 40, '2026-05-01', 2, 5);

-- Theme 6: 기간 내 예약 5개
INSERT INTO reservation (id, store_id, guest_id, date, time_id, theme_id)
VALUES (41, 1, 41, '2026-04-29', 1, 6),
       (42, 1, 42, '2026-04-29', 2, 6),
       (43, 1, 43, '2026-04-30', 1, 6),
       (44, 1, 44, '2026-04-30', 2, 6),
       (45, 1, 45, '2026-05-01', 1, 6);

-- Theme 7: 기간 내 예약 4개
INSERT INTO reservation (id, store_id, guest_id, date, time_id, theme_id)
VALUES (46, 1, 46, '2026-04-29', 1, 7),
       (47, 1, 47, '2026-04-29', 2, 7),
       (48, 1, 48, '2026-04-30', 1, 7),
       (49, 1, 49, '2026-04-30', 2, 7);

-- Theme 8: 기간 내 예약 3개
INSERT INTO reservation (id, store_id, guest_id, date, time_id, theme_id)
VALUES (50, 1, 50, '2026-04-29', 1, 8),
       (51, 1, 51, '2026-04-29', 2, 8),
       (52, 1, 52, '2026-04-30', 1, 8);

-- Theme 9: 기간 내 예약 2개
INSERT INTO reservation (id, store_id, guest_id, date, time_id, theme_id)
VALUES (53, 1, 53, '2026-04-29', 1, 9),
       (54, 1, 54, '2026-04-29', 2, 9);

-- Theme 10: 기간 내 예약 1개
INSERT INTO reservation (id, store_id, guest_id, date, time_id, theme_id)
VALUES (55, 1, 55, '2026-04-29', 1, 10);

-- Theme 11: 기간 밖 예약만 있음
INSERT INTO reservation (id, store_id, guest_id, date, time_id, theme_id)
VALUES (56, 1, 56, '2026-04-28', 1, 11),
       (57, 1, 57, '2026-05-06', 1, 11),
       (58, 1, 58, '2026-05-06', 2, 11);
